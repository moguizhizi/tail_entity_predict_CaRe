...
from utils import uniform, multihop_sampling
...
class GraphSage(nn.Module):
    def __init__(self, input_dim, hidden_dim, num_neighbors_list, entPoolType, neighbor_node):
    ...
    def forward(self, x, src_index):
        ...
        sampling_result = multihop_sampling(src_index, self.num_neighbors_list, self.neighbor_node)
        hidden = [x[idx].float() for idx in sampling_result]
